...
<body>
    ...
    <script>
        ...
        const products = [
            { id: 1, name: "Sepatu Lari X-Trail", category: "Sepatu Olahraga", price: 450000, stock: 23, status: "Aktif" },
            { id: 2, name: "Kaos Olahraga DryFit", category: "Pakaian", price: 120000, stock: 15, status: "Aktif" },
            { id: 3, name: "Sepatu Kasual Urban", category: "Sepatu Kasual", price: 350000, stock: 7, status: "Stok Rendah" },
            { id: 4, name: "Tas Olahraga Multifungsi", category: "Aksesoris", price: 250000, stock: 12, status: "Aktif" },
            { id: 5, name: "Sepatu Basket Pro", category: "Sepatu Olahraga", price: 620000, stock: 5, status: "Stok Rendah" }
        ];
        ...
        document.getElementById("productForm").addEventListener("submit", function(e) {
            ...
            const status = stock > 10 ? "Aktif" : "Stok Rendah";
            const statusClass = status === "Aktif" ? "status-processing" : "status-pending";
